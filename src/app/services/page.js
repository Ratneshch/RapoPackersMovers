    ...
    <main className="w-full">
      ...
      <section className="relative w-full min-h-[60vh] flex items-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12">
          <span className="inline-block mt-14 px-4 py-2 text-sm font-semibold text-white bg-white/20 backdrop-blur rounded-full">
            Our Services
          </span>

          <h1 className="text-white font-extrabold text-4xl md:text-6xl leading-tight">
            Comprehensive <span className="text-orange-500">Moving</span>{" "}
            Solutions
          </h1>
